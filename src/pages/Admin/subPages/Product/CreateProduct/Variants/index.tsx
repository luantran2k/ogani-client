    ...
    <Box ref={variantList} margin="0">
        ...
        <Grid container spacing={2} key={index} marginLeft={-2}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onBlur={(e) => {
                onBlurUpdateFieldVariant(e, variant.id, "price", "number");
              }}
              fullWidth
            />
          </Grid>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onBlur={(e) => {
                onBlurUpdateFieldVariant(e, variant.id, "quantity", "number");
              }}
              fullWidth
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onBlur={(e) => {
                onBlurUpdateFieldVariant(e, variant.id, "variant");
              }}
              fullWidth
            >
      ...
      <Stack direction="row" justifyContent="center" marginTop={2}>
        <Button
          variant="outlined"
          onClick={() =>
            setVariants((variants) => [...variants, getEmptyVariant()])
          }
        >
          Create new variant
        </Button>
